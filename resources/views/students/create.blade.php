                ...
                <div class="p-6 sm:px-20 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('students.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="number" name="age" id="age" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ old('age') }}" />
                        </div>
                        <div class="flex items center justify-between">
                            <a href="{{ route('students.index') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">Volver</a>
                            <button type="submit" class="bg-cyan-500 hover:bg-cyan-700 text-white font-bold py-2 px-4 rounded">Crear Estudiante</button>
                        </div>
                    </form>
            </div>
        </div>
